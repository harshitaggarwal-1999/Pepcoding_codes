...
public class jauspay1 {
    static HashMap<Integer, ArrayList<Integer>> maps = new HashMap<>();
    public static void main(String[] args) throws Exception {
        ...
        while(q.size() > 0){
            ...
            if(!maps.containsKey(currpair.first)){
                continue;
            }

            ArrayList<Integer> currlist = maps.get(currpair.first);
            ...
            for(int  i : currlist){
                ...
                int val = currpair.second+c;
                
                if(((currpair.second/t)%2 == 1)){
                    val += t-(currpair.second%t);
                }
    ...
    //-------------------------------- HO JA BHAI ----------------------------------------------------
    /* code ends here*/
//xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx U  T  I  L  I  T  I  E  S 
