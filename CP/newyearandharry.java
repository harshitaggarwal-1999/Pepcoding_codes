...
// >>>>>>>>>>>>>>>>>>>>>>>>>>>> CODE STARTS HERE <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
    ...
    public static void solver() {
        ...
        // int timeforsolving = 240-k;
        // ArrayList<Integer> arr = new ArrayList<>();
        // arr.add(5);
        // for(int i = 1 ; arr.get(i-1)<240; i++){
        //     arr.add(5*(i+1));
        // }
        // arr.remove(arr.size()-1);
        // // System.out.println(arr);
        // int[] arri =  convertIntegers(arr);
        // int count = 0;
        
        // for(int i = 0; i < arri.length && timeforsolving-arri[i] >= 0 && count<n; i++){
        //     timeforsolving-=arri[i];count++;
        //     // System.out.println(timeforsolving+ " "+ count);
        // }
        ...
        for(int i = 0; i < n; i++){
            ...
            if(total+k==240){System.out.println(i+1);return;}
            else if(total+k>240){System.out.println(i);return;}
        }
