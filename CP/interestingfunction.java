...
//>>>>>>>>>>>>>>>>>>>>>>>>>> SWAP <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
    ...
    public static void solver() {
        ...
        int ldigits= changeddigits(l);
        int rdigits = changeddigits(r);
        
        System.out.println("ldigit: "+ldigits+" rdigits: "+rdigits);
        System.out.println(rdigits-ldigits);



    }

    public static int changeddigits(int n){
        int num = 100000000;
        int rem = 0;
        while(num != 0){
            System.out.println("n: " + n + " num: "+ num + " n/num: "+ n/num);
