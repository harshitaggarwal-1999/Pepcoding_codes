...
//>>>>>>>>>>>>>>>>>>>>>>>>>> SWAP <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
    ...
    public static void solver() {
        ...
        Arrays.sort(arr);
        //true means right
        boolean largestelem = false;
        boolean sclargestelem = false;
        ...
        // }
        // System.out.println();
        if(arr[arr.length-1] == oldarr[arr.length-1] || arr[arr.length-1] == oldarr[arr.length-2]){
            largestelem = true;
        }else{
            largestelem = false;
        }

        if(arr[arr.length-2] == oldarr[arr.length-1] || arr[arr.length-2] == oldarr[arr.length-2]){
            sclargestelem = true;
        }else {
            sclargestelem = false;
        }

        if(largestelem == true && sclargestelem == true){
            System.out.println("NO");
            return;
        }
        if(largestelem == false && sclargestelem == false){
            System.out.println("NO");
            return;
        }
        if(largestelem == true && sclargestelem == false){
            System.out.println("YES");
            return;
        }
        if(largestelem == false && sclargestelem == true){
            System.out.println("YES");
            return;
        }
