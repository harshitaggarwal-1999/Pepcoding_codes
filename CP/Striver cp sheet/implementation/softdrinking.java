...
public class softdrinking {
    ...
    public static void solver() {
        ...
        int totalSlicesOfLime = c*d;
        int totalSalt = p;

        int totalAvailableDrink = totalMLofDrink/nl;
        int totalSaltUsed = p/np;

        int ans = Math.min(totalAvailableDrink, totalSlicesOfLime);
        ans = Math.min(ans, totalSaltUsed);
