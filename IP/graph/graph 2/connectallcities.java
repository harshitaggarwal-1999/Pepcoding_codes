...
public class connectallcities {
    ...
    public static int prims(int[][] grid) {
        ...
        while(pq.size() > 0){
            ...
            for(int i = 0 ; i < grid[rem.vtx].length; i++){// as 0, 0 ko nikala then oth row par jitne bhi columns the uska arraymangva liya if i == removed ke vtx ke equal hai to continue kardo as vo process nahi hogi usse uss tak ka rasta is 0 then pair bana bana kar daalo like arr[0][1] ka pair bnanege (1,arr[0][1]) vtx and uska wt phir neeche dekhenge pq me add karne se pehle agar uss vtx pehle se visisted hai to chordo yaa uss vtx ka wt == 0 hai to rehndo as vaha road hi exist nahi karti hogi......phir again aisa same kaam 2,arr[0][2] ke saath karenge and pair bnao conditioons check karo add karne ki and vroom in loop again
                
                if(i == rem.vtx){
                    continue;
                }
                Pair p = new Pair(i,grid[rem.vtx][i]);
                if(p.wt == 0 || visited[p.vtx] == true){
                    continue;
                }
                pq.add(p);
            }
...

    ...
    static class Pair implements Comparable<Pair> { int vtx, wt; public Pair(int vtx, int wt) { this.vtx = vtx; this.wt = wt; } public int compareTo(Pair o) { return this.wt- o.wt; } }
