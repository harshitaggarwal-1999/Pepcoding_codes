class Solution {
    public int cherryPickup(int[][] grid) {
        ...
        int ans  = cherry(grid, 0,0,0,0, new Integer[n][m][n]);
    ...
    public int cherry(int[][] grid, int row1, int col1, int row2, Integer[][][] dp){
        //r1 + c1 = r2 + c2;
        ...
        int temp1 = cherry(grid, row1, col1+1, row2, dp); // R R
        int temp2 = cherry(grid, row1+1, col1, row2+1, dp); // D D
        int temp3 = cherry(grid, row1, col1+1, row2+1, dp); // R D
        int temp4 = cherry(grid, row1+1, col1, row2, dp); // D R
